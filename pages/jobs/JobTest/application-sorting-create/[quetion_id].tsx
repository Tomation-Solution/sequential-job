...
import { getCutOffForQuetion, getCutOffForTest, setCutOffForQuetion, setCutOffForTest } from "../../../../service/api/job.api";
...
const ApplicationSorting:NextPage = ()=>{
    ...
    const {isLoading , data,status} = useQuery(['cut_off_mark',quetion_id],()=>getCutOffForTest(typeof quetion_id== 'string'?quetion_id:'0'),{
    ...
    const {isLoading:submittingStatus,mutate}  = useMutation(setCutOffForTest,{
        'onSuccess':(data)=>{
                console.log(data)
